...
public class CadastroPFDto {
	...
	private Optional<String> valorHora = Optional.empty(), qtdHorasTrabalhoDia = Optional.empty(),
	...
	@Length(min = 5, max = 200, message = "Email deve ter entre 3 e 200 caracteres.")
